...
process.convNtupl = cms.Path(process.newConv)
...
process.nuclNtupl = cms.Path(disp*process.nucl)
...
readFiles.extend( [
##'file:/raid/sguazz/test/182C7A8D-C411-E111-AB23-0026189438DD.root'
'file:/raid/sguazz/test/reco_9288DF20-CEFC-E011-8962-003048678B8E.root'
] );
## secFiles.extend( [
##                ] )

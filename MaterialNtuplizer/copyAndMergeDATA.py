import os
pippo  = 'hadd /tmp/cerati/ntuple_conversion_CMSSW358p3_goodcoll7TeV.root '
pippo2 = 'hadd /tmp/cerati/ntuple_nuclint_CMSSW358p3_goodcoll7TeV.root '
...
os.system(pippo)
os.system(pippo2)
os.system('rfcp /tmp/cerati/ntuple_conversion_CMSSW358p3_goodcoll7TeV.root $CASTOR_HOME/MaterialNtuples/ntuple_conversion_CMSSW358p3_goodcoll7TeV_2010-05-03.root')
os.system('rfcp /tmp/cerati/ntuple_nuclint_CMSSW358p3_goodcoll7TeV.root $CASTOR_HOME/MaterialNtuples/ntuple_nuclint_CMSSW358p3_goodcoll7TeV_2010-05-03.root')
#os.system('rm /tmp/cerati/*.root')
#for i in range(1,204):
#    os.system('rfrm /castor/cern.ch/cms/store/caf/user/cerati/ntuple_conversion_CMSSW358p3_goodcoll900GeV_'+str(i)+'.root')

...
process.conv = cms.EDAnalyzer('NewConversionNtuplizer',
...
process.noScraping = cms.EDFilter("FilterOutScraping",
    ...
    numtrack = cms.untracked.uint32(100),
...
process.default = cms.Sequence(process.siPixelRecHits*process.siStripMatchedRecHits*process.ckftracks_wodEdX*
                               process.trackerOnlyConversionSequence*process.conv)

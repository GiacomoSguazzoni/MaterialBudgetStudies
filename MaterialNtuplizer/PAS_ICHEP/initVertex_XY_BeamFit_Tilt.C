...
void initVertex_XY_BeamFit_Tilt(){
  ...
  string sBeamPipes("Plots_4T_before2T_allvtx/BeamPipes_bkg1_isNucl_3Vtx.png");
  string sParameters("Plots_4T_before2T_allvtx/Parameters_bkg1_isNucl_3Vtx.png");
  string sSingleBeamPipe("Plots_4T_before2T_allvtx/SingleBeamPipe_isNucl_3Vtx.png");
  string cBeamPipes("Plots_4T_before2T_allvtx/BeamPipes_bkg1_isNucl_3Vtx.C");
  string cParameters("Plots_4T_before2T_allvtx/Parameters_bkg1_isNucl_3Vtx.C");
  string cSingleBeamPipe("Plots_4T_before2T_allvtx/SingleBeamPipe_isNucl_3Vtx.C");
  string rBeamPipes("Plots_4T_before2T_allvtx/BeamPipes_bkg1_isNucl_3Vtx.root");
  string rParameters("Plots_4T_before2T_allvtx/Parameters_bkg1_isNucl_3Vtx.root");
  /*
    string fileName = "2011_4T_isNucl_before2T.root";
    string sBeamPipes("Plots_4T_isNucl_before2T/BeamPipes_bkg1.png");
    string sParameters("Plots_4T_isNucl_before2T/Parameters_bkg1.png");
  */

  /*
    string fileName = "2011_4T_isNucl_after2T.root";
    string sBeamPipes("Plots_4T_isNucl_after2T/BeamPipes_bkg1.png");
    string sParameters("Plots_4T_isNucl_after2T/Parameters_bkg1.png");
  */
  ...
  string png = "Plots2T_isNucl/BeamPipe_BEAMPIPE.png";
  int n = -1;
  int l = -1;
  int rn = -1;
  ...
  TCanvas* singleCanvas = new TCanvas("c2", "", 500, 500);
  ...
  for (int i = 4; i > 3; i--){
    ...
    switch (i){
    case 8: 
      hFIT = (TH2D*) f->Get("XY_PIX_BARREL_ZOOM_35z40;1");
      hBKG = (TH1D*) f->Get("RHO_BARREL_ZOOM_BEAMPIPE_35z40;1");
      png = "Plots/BeamPipe_BEAMPIPE_35z40.png";
      T = new TText(-2, 0, "35 < z < 40");
      break;
    case 7: 
      hFIT = (TH2D*) f->Get("XY_PIX_BARREL_ZOOM_30z35;1");
      hBKG = (TH1D*) f->Get("RHO_BARREL_ZOOM_BEAMPIPE_30z35;1");
      png = "Plots/BeamPipe_BEAMPIPE_30z35.png";
      T = new TText(-2, 0, "30 < z < 35");
      break;
    case 6: 
      hFIT = (TH2D*) f->Get("XY_PIX_BARREL_ZOOM_25z30;1");
      hBKG = (TH1D*) f->Get("RHO_BARREL_ZOOM_BEAMPIPE_25z30;1");
      png = "Plots/BeamPipe_BEAMPIPE_25z30.png";
      T = new TText(-2, 0, "25 < z < 30");
      break;
    case 5: 
      hFIT = (TH2D*) f->Get("XY_PIX_BARREL_ZOOM_20z25;1");
      hBKG = (TH1D*) f->Get("RHO_BARREL_ZOOM_BEAMPIPE_20z25;1");
      png = "Plots/BeamPipe_BEAMPIPE_20z25.png";
      T = new TText(-2, 0, "20 < z < 25");
      break;
    case 4: 
      hFIT = (TH2D*) f->Get("XY_PIX_BARREL_ZOOM_15z20;1");
      hBKG = (TH1D*) f->Get("RHO_BARREL_ZOOM_BEAMPIPE_15z20;1");
      hFIT->Copy(*hPLOT);
      png = "Plots/BeamPipe_BEAMPIPE_15z20.png";
      T = new TText(-2, 0, "15 < z < 20");
      break;
    case 3: 
      hFIT = (TH2D*) f->Get("XY_PIX_BARREL_ZOOM_10z15;1");
      hBKG = (TH1D*) f->Get("RHO_BARREL_ZOOM_BEAMPIPE_10z15;1");
      png = "Plots/BeamPipe_BEAMPIPE_10z15.png";
      T = new TText(-2, 0, "10 < z < 15");
      break;
    case 2: 
      hFIT = (TH2D*) f->Get("XY_PIX_BARREL_ZOOM_5z10;1");
      hBKG = (TH1D*) f->Get("RHO_BARREL_ZOOM_BEAMPIPE_5z10;1");
      png = "Plots/BeamPipe_BEAMPIPE_5z10.png";
      T = new TText(-2, 0, "5 < z < 10");
      break;
    case 1: 
      hFIT = (TH2D*) f->Get("XY_PIX_BARREL_ZOOM_0z5;1");
      hBKG = (TH1D*) f->Get("RHO_BARREL_ZOOM_BEAMPIPE_0z5;1");
      png = "Plots/BeamPipe_BEAMPIPE_0z5.png";
      T = new TText(-2, 0, "0 < z < 5");
      break;
    case 0: 
      hFIT = (TH2D*) f->Get("XY_PIX_BARREL_ZOOM_m5z0;1");
      hBKG = (TH1D*) f->Get("RHO_BARREL_ZOOM_BEAMPIPE_m5z0;1");
      hFIT->Copy(*hPLOT);
      png = "Plots/BeamPipe_BEAMPIPE_m5z0.png";
      T = new TText(-2, 0, "-5 < z < 0");
      break;
    case -1: 
      hFIT = (TH2D*) f->Get("XY_PIX_BARREL_ZOOM_m10z5;1");
      hBKG = (TH1D*) f->Get("RHO_BARREL_ZOOM_BEAMPIPE_m10z5;1");
      png = "Plots/BeamPipe_BEAMPIPE_m10z5.png";
      T = new TText(-2, 0, "-10 < z < -5");
      break;
    case -2: 
      hFIT = (TH2D*) f->Get("XY_PIX_BARREL_ZOOM_m15z10;1");
      hBKG = (TH1D*) f->Get("RHO_BARREL_ZOOM_BEAMPIPE_m15z10;1");
      png = "Plots/BeamPipe_BEAMPIPE_m15z10.png";
      T = new TText(-2, 0, "-15 < z < -10");
      break;
    case -3: 
      hFIT = (TH2D*) f->Get("XY_PIX_BARREL_ZOOM_m20z15;1");
      hBKG = (TH1D*) f->Get("RHO_BARREL_ZOOM_BEAMPIPE_m20z15;1");
      png = "Plots/BeamPipe_BEAMPIPE_m20z15.png";
      T = new TText(-2, 0, "-20 < z < -15");
      break;
    case -4: 
      hFIT = (TH2D*) f->Get("XY_PIX_BARREL_ZOOM_m25z20;1");
      hBKG = (TH1D*) f->Get("RHO_BARREL_ZOOM_BEAMPIPE_m25z20;1");
      png = "Plots/BeamPipe_BEAMPIPE_m25z20.png";
      T = new TText(-2, 0, "-25 < z < -20");
      break;
    case -5: 
      hFIT = (TH2D*) f->Get("XY_PIX_BARREL_ZOOM_m30z25;1");
      hBKG = (TH1D*) f->Get("RHO_BARREL_ZOOM_BEAMPIPE_m30z25;1");
      png = "Plots/BeamPipe_BEAMPIPE_m30z25.png";
      T = new TText(-2, 0, "-30 < z < -25");
      break;
    case -6: 
      hFIT = (TH2D*) f->Get("XY_PIX_BARREL_ZOOM_m35z30;1");
      hBKG = (TH1D*) f->Get("RHO_BARREL_ZOOM_BEAMPIPE_m35z30;1");
      png = "Plots/BeamPipe_BEAMPIPE_m35z30.png";
      T = new TText(-2, 0, "-35 < z < -30");
      break;
    case -7: 
      hFIT = (TH2D*) f->Get("XY_PIX_BARREL_ZOOM_m40z35;1");
      hBKG = (TH1D*) f->Get("RHO_BARREL_ZOOM_BEAMPIPE_m40z35;1");
	...
	if (i ==4){
	  ...
	  L->Draw();
	  T->Draw();
	  singleCanvas->SaveAs(sSingleBeamPipe.c_str());
	  singleCanvas->SaveAs(cSingleBeamPipe.c_str());
        }       
  ...
  TFile* out= new TFile("Plots_4T_before2T_allvtx/out_Parameters_bkg1_allvtx.root","recreate");
  gX->SetTitle("gX");
  gY->SetTitle("gY");
  gR->SetTitle("gR");
  out->Close();
...
substractBkg(){
  ...
  for (int k = 1; k <= hFIT->GetNbinsX(); k++){
    for (int l = 1; l <= hFIT->GetNbinsY(); l++){
      ...
      double CorrectedContent = Content/solidAngle - density*( area/(width*2*TMath::Pi()*rho))*1.0;

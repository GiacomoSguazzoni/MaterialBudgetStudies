...
TCut nuclCut = "isNucl && (tkDxy[0] > 0.3 || tkDxy[0] < -0.3) && (tkDxy[1] > 0.3 || tkDxy[1] < -0.3) && mOut > 1.0";//  && angle < 6";// && (nOutTkStep67Poor + nOutTkStep67Good == 0)";
...
void ProduceNuclearHistos_BEAMPIPE_primVtx(){
  ...
  // string s_file = "2011_4T_isNucl_before2T_wVtx_exclusiveVtx.root";

  string s_file = "2011_2T_isNucl_wVtx_exclusiveVtx_M1GeV.root";
...
//--------------------------------------//
 ...
 PlottiPlotta2D();
  ...
  for (int vtx = 1; vtx < 17; vtx++){

    float fvtx = vtx + 0.1;
    float lowvtx = vtx - 0.1;
    string plotName_vtx(Form("vtx_%d", vtx));

    string s(Form("evt_NofflineVtx < %lg && evt_NofflineVtx > %lg", fvtx, lowvtx));
    //string s(Form("evt_NofflineVtx < %lg", fvtx));

    TCut cVtx = s.c_str();

    generalCut_vtx = nuclCut && cVtx;
  ...
  //--------------------------------------//
    ...
    nbins = 20; 
    min = 0.0, max = min + nbins*1;
    plotName  = "" + plotName_vtx + "PrimVtx";
    histo_title = "#rho Nucl";
    xaxis_title = "#rho Nucl (cm)";
    variable = "evt_NofflineVtx";
    cut0 = "";
    cut = cut0&&generalCut_vtx;
    ...
    plotName  = "" + plotName_vtx + "RHO_BARREL_ZOOM_BEAMPIPE_35z40";
    histo_title = "#rho Nucl";
    xaxis_title = "#rho Nucl (cm)";
    variable = "rho";
    cut0 = "z < 40 && z > 35";
    ...
    plotName  = "" + plotName_vtx + "RHO_BARREL_ZOOM_BEAMPIPE_30z35";
    histo_title = "#rho Nucl";
    xaxis_title = "#rho Nucl (cm)";
    variable = "rho";
    cut0 = "z < 35 && z > 30";
    ...
    nbins = 100; 
    min = 2, max = min + nbins*0.02;
    plotName  = "" + plotName_vtx + "RHO_BARREL_ZOOM_BEAMPIPE_25z30";
    histo_title = "#rho Nucl";
    xaxis_title = "#rho Nucl (cm)";
    variable = "rho";
    cut0 = "z < 30 && z > 25";
    ...
    nbins = 100; 
    min = 2, max = min + nbins*0.02;
    plotName  = "" + plotName_vtx + "RHO_BARREL_ZOOM_BEAMPIPE_20z25";
    histo_title = "#rho Nucl";
    xaxis_title = "#rho Nucl (cm)";
    variable = "rho";
    cut0 = "z < 25 && z > 20";
    ...
    nbins = 100; 
    min = 2, max = min + nbins*0.02;
    plotName  = "" + plotName_vtx + "RHO_BARREL_ZOOM_BEAMPIPE_15z20";
    histo_title = "#rho Nucl";
    xaxis_title = "#rho Nucl (cm)";
    variable = "rho";
    cut0 = "z < 20 && z > 15";
    ...
    nbins = 100; 
    min = 2, max = min + nbins*0.02;
    plotName  = "" + plotName_vtx + "RHO_BARREL_ZOOM_BEAMPIPE_10z15";
    histo_title = "#rho Nucl";
    xaxis_title = "#rho Nucl (cm)";
    variable = "rho";
    cut0 = "z < 15 && z > 10";
    ...
    nbins = 100; 
    min = 2, max = min + nbins*0.02;
    plotName  = "" + plotName_vtx + "RHO_BARREL_ZOOM_BEAMPIPE_5z10";
    histo_title = "#rho Nucl";
    xaxis_title = "#rho Nucl (cm)";
    variable = "rho";
    cut0 = "z < 10 && z > 5";
    ...
    nbins = 100; 
    min = 2, max = min + nbins*0.02;
    plotName  = "" + plotName_vtx + "RHO_BARREL_ZOOM_BEAMPIPE_0z5";
    histo_title = "#rho Nucl";
    xaxis_title = "#rho Nucl (cm)";
    variable = "rho";
    cut0 = "z < 5 && z > 0";
    ...
    nbins = 100; 
    min = 2, max = min + nbins*0.02;
    plotName  = "" + plotName_vtx + "RHO_BARREL_ZOOM_BEAMPIPE_m5z0";
    histo_title = "#rho Nucl";
    xaxis_title = "#rho Nucl (cm)";
    variable = "rho";
    cut0 = "z < 0 && z > -5";
    ...
    nbins = 100; 
    min = 2, max = min + nbins*0.02;
    plotName  = "" + plotName_vtx + "RHO_BARREL_ZOOM_BEAMPIPE_m10z5";
    histo_title = "#rho Nucl";
    xaxis_title = "#rho Nucl (cm)";
    variable = "rho";
    cut0 = "z < -5 && z > -10";
    ...
    nbins = 100; 
    min = 2, max = min + nbins*0.02;
    plotName  = "" + plotName_vtx + "RHO_BARREL_ZOOM_BEAMPIPE_m15z10";
    histo_title = "#rho Nucl";
    xaxis_title = "#rho Nucl (cm)";
    variable = "rho";
    cut0 = "z < -10 && z > -15";
    ...
    nbins = 100; 
    min = 2, max = min + nbins*0.02;
    plotName  = "" + plotName_vtx + "RHO_BARREL_ZOOM_BEAMPIPE_m20z15";
    histo_title = "#rho Nucl";
    xaxis_title = "#rho Nucl (cm)";
    variable = "rho";
    cut0 = "z < -15 && z > -20";
    ...
    nbins = 100; 
    min = 2, max = min + nbins*0.02;
    plotName  = "" + plotName_vtx + "RHO_BARREL_ZOOM_BEAMPIPE_m25z20";
    histo_title = "#rho Nucl";
    xaxis_title = "#rho Nucl (cm)";
    variable = "rho";
    cut0 = "z < -20 && z > -25";
    ...
    nbins = 100; 
    min = 2, max = min + nbins*0.02;
    plotName  = "" + plotName_vtx + "RHO_BARREL_ZOOM_BEAMPIPE_m30z25";
    histo_title = "#rho Nucl";
    xaxis_title = "#rho Nucl (cm)";
    variable = "rho";
    cut0 = "z < -25 && z > -30";
    ...
    nbins = 100; 
    min = 2, max = min + nbins*0.02;
    plotName  = "" + plotName_vtx + "RHO_BARREL_ZOOM_BEAMPIPE_m35z30";
    histo_title = "#rho Nucl";
    xaxis_title = "#rho Nucl (cm)";
    variable = "rho";
    cut0 = "z < -30 && z > -35";
    ...
    nbins = 100; 
    min = 2, max = min + nbins*0.02;
    plotName  = "" + plotName_vtx + "RHO_BARREL_ZOOM_BEAMPIPE_m40z35";
    histo_title = "#rho Nucl";
    xaxis_title = "#rho Nucl (cm)";
    variable = "rho";
    cut0 = "z < -35 && z > -40";
    ...
    plotName = "" + plotName_vtx + "XY_PIX_BARREL_ZOOM_35z40";
    histo_title = "XY Nucl PIX BARREL";
    xaxis_title = "x (cm)"
      yaxis_title = "y (cm)";
    ...
    nbins1 = 180; 
    min1 = -4.5, max1 = min1 + nbins1*0.05;
    plotName = "" + plotName_vtx + "XY_PIX_BARREL_ZOOM_30z35";
    histo_title = "XY Nucl PIX BARREL";
    xaxis_title = "x (cm)"
      yaxis_title = "y (cm)";
    variable = "y";  variable1 = "x";
    ...
    nbins1 = 180; 
    min1 = -4.5, max1 = min1 + nbins1*0.05;
    plotName = "" + plotName_vtx + "XY_PIX_BARREL_ZOOM_25z30";
    histo_title = "XY Nucl PIX BARREL";
    xaxis_title = "x (cm)"
      yaxis_title = "y (cm)";
    variable = "y";  variable1 = "x";
    ...
    nbins1 = 180; 
    min1 = -4.5, max1 = min1 + nbins1*0.05;
    plotName = "" + plotName_vtx + "XY_PIX_BARREL_ZOOM_20z25";
    histo_title = "XY Nucl PIX BARREL";
    xaxis_title = "x (cm)"
      yaxis_title = "y (cm)";
    variable = "y";  variable1 = "x";
    ...
    nbins1 = 180; 
    min1 = -4.5, max1 = min1 + nbins1*0.05;
    plotName = "" + plotName_vtx + "XY_PIX_BARREL_ZOOM_15z20";
    histo_title = "XY Nucl PIX BARREL";
    xaxis_title = "x (cm)"
      yaxis_title = "y (cm)";
    variable = "y";  variable1 = "x";
    ...
    nbins1 = 180; 
    min1 = -4.5, max1 = min1 + nbins1*0.05;
    plotName = "" + plotName_vtx + "XY_PIX_BARREL_ZOOM_10z15";
    histo_title = "XY Nucl PIX BARREL";
    xaxis_title = "x (cm)"
      yaxis_title = "y (cm)";
    variable = "y";  variable1 = "x";
    ...
    nbins1 = 180; 
    min1 = -4.5, max1 = min1 + nbins1*0.05;
    plotName = "" + plotName_vtx + "XY_PIX_BARREL_ZOOM_5z10";
    histo_title = "XY Nucl PIX BARREL";
    xaxis_title = "x (cm)"
      yaxis_title = "y (cm)";
    variable = "y";  variable1 = "x";
    ...
    nbins1 = 180; 
    min1 = -4.5, max1 = min1 + nbins1*0.05;
    plotName = "" + plotName_vtx + "XY_PIX_BARREL_ZOOM_0z5";
    histo_title = "XY Nucl PIX BARREL";
    xaxis_title = "x (cm)"
      yaxis_title = "y (cm)";
    variable = "y";  variable1 = "x";
    ...
    nbins1 = 180; 
    min1 = -4.5, max1 = min1 + nbins1*0.05;
    plotName = "" + plotName_vtx + "XY_PIX_BARREL_ZOOM_m5z0";
    histo_title = "XY Nucl PIX BARREL";
    xaxis_title = "x (cm)"
      yaxis_title = "y (cm)";
    variable = "y";  variable1 = "x";
    ...
    nbins1 = 180; 
    min1 = -4.5, max1 = min1 + nbins1*0.05;
    plotName = "" + plotName_vtx + "XY_PIX_BARREL_ZOOM_m5z5";
    histo_title = "XY Nucl PIX BARREL";
    xaxis_title = "x (cm)"
      yaxis_title = "y (cm)";
    variable = "y";  variable1 = "x";
    ...
    nbins1 = 180; 
    min1 = -4.5, max1 = min1 + nbins1*0.05;
    plotName = "" + plotName_vtx + "XY_PIX_BARREL_ZOOM_m10z5";
    histo_title = "XY Nucl PIX BARREL";
    xaxis_title = "x (cm)"
      yaxis_title = "y (cm)";
    variable = "y";  variable1 = "x";
    ...
    nbins1 = 180; 
    min1 = -4.5, max1 = min1 + nbins1*0.05;
    plotName = "" + plotName_vtx + "XY_PIX_BARREL_ZOOM_m15z10";
    histo_title = "XY Nucl PIX BARREL";
    xaxis_title = "x (cm)"
      yaxis_title = "y (cm)";
    variable = "y";  variable1 = "x";
    ...
    nbins1 = 180; 
    min1 = -4.5, max1 = min1 + nbins1*0.05;
    plotName = "" + plotName_vtx + "XY_PIX_BARREL_ZOOM_m20z15";
    histo_title = "XY Nucl PIX BARREL";
    xaxis_title = "x (cm)"
      yaxis_title = "y (cm)";
    variable = "y";  variable1 = "x";
    ...
    nbins1 = 180; 
    min1 = -4.5, max1 = min1 + nbins1*0.05;
    plotName = "" + plotName_vtx + "XY_PIX_BARREL_ZOOM_m25z20";
    histo_title = "XY Nucl PIX BARREL";
    xaxis_title = "x (cm)"
      yaxis_title = "y (cm)";
    variable = "y";  variable1 = "x";
    ...
    nbins1 = 180; 
    min1 = -4.5, max1 = min1 + nbins1*0.05;
    plotName = "" + plotName_vtx + "XY_PIX_BARREL_ZOOM_m30z25";
    histo_title = "XY Nucl PIX BARREL";
    xaxis_title = "x (cm)"
      yaxis_title = "y (cm)";
    variable = "y";  variable1 = "x";
    ...
    nbins1 = 180; 
    min1 = -4.5, max1 = min1 + nbins1*0.05;
    plotName = "" + plotName_vtx + "XY_PIX_BARREL_ZOOM_m35z30";
    histo_title = "XY Nucl PIX BARREL";
    xaxis_title = "x (cm)"
      yaxis_title = "y (cm)";
    variable = "y";  variable1 = "x";
    ...
    nbins1 = 180; 
    min1 = -4.5, max1 = min1 + nbins1*0.05;
    plotName = "" + plotName_vtx + "XY_PIX_BARREL_ZOOM_m40z35";
    histo_title = "XY Nucl PIX BARREL";
    xaxis_title = "x (cm)"
      yaxis_title = "y (cm)";
    variable = "y";  variable1 = "x";
    ...
    nbins1 = 180; 
    min1 = -4.5, max1 = min1 + nbins1*0.05;
    plotName = "" + plotName_vtx + "XY_PIX_BARREL_ZOOM_m45z40";
    histo_title = "XY Nucl PIX BARREL";
    xaxis_title = "x (cm)"
      yaxis_title = "y (cm)";
    variable = "y";  variable1 = "x";

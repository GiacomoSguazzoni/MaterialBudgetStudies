...
process.conv = cms.EDAnalyzer('ConversionNtuplizer',
                              outfile = cms.string('ntuple_conversion_minbias7TeV_test.root'),
...
process.convHit = process.conv.clone(outfile = cms.string('ntuple_conversion_minbias7TeV_test_hit.root'),hitassoc = cms.bool(True))

process.convNew = cms.EDAnalyzer('NewConversionNtuplizer',
                                 outfile = cms.string('ntuple_conversion_minbias7TeV_test_new.root'),
                                 redovtx = cms.bool(True),
                                 hitassoc = cms.bool(False),
                                 minPhoPtForEffic = cms.double(0.3),#when hardcoded it was 2.5
                                 maxPhoEtaForEffic = cms.double(2.5),
...
process.nucl = cms.EDAnalyzer('NuclIntNtuplizer',
                              outfile = cms.string('ntuple_nuclint_minbias7TeV_test.root'),
                              hitassoc = cms.bool(False),
                              simulation = cms.bool(True),
                              prints = cms.bool(False)
)
